...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ATOnboarding.podspec."
  ...
  spec.homepage     = "http://EXAMPLE/ATOnboarding.podspec"
  ...
  spec.source       = { :git => "http://EXAMPLE/ATOnboarding.podspec.git", :tag => "#{spec.version}" }
